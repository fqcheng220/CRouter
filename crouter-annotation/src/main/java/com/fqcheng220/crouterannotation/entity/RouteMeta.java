package com.fqcheng220.crouterannotation.entity;
...
public class RouteMeta {
    ...
    public RouteMeta(String host,String path,List<ParameterMeta> parameterMetaList,boolean rtnObservable) {
        mHost = host;
        mPath = path;
    ...
    //            Object[] objArgs = analysisPostCard(postCard);
    //            return (Observable<Response>) mMethodInvoker.invoke(objArgs);
    //        } else {
    ...
    //    Object[] objArgs = analysisPostCard(postCard);
    //    mMethodInvoker.invoke(objArgs);
    //}
    //
    //private Object[] analysisPostCard(PostCard postCard) {
    ...
    //    }
    //    Object[] objArgs = new Object[mParameterMetaList.size()];
    ...
    //            }
    //            if (value != null) {
    //                Converter converter = mCommontConverterFactory.requestConverter(mParameterMetaList.get(i).mType);
    //                if (converter != null) {
    //                    objArgs[i] = converter.convert((String) value);
    //                } else {
    //                    objArgs[i] = pathQueryMap.get(mParameterQueryList.get(i));
    //                }
    //            } else {
    //                objArgs[i] = null;
    //            }
